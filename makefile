...
#       $(BUILD_DIR)/syscall-init.o $(BUILD_DIR)/syscall.o $(BUILD_DIR)/stdio.o $(BUILD_DIR)/stdio-kernel.o $(BUILD_DIR)/ide.o
...
#         lib/user/syscall.h userprog/syscall-init.h lib/stdio.h lib/kernel/stdio-kernel.h
# 	$(CC) $(CFLAGS) $< -o $@
...
# 	$(CC) $(CFLAGS) $< -o $@
# $(BUILD_DIR)/printk.o: lib/stdio.h lib/kernel/stdio-kernel
# 	$(CC) $(CFLAGS) $< -o $@
...
CC = gcc
LD = ld
LIB = -I lib/ -I lib/kernel/ -I lib/user/ -I kernel/ -I device/ -I fs/
ASFLAGS = -f elf
CFLAGS = -Wall -m32 -fno-stack-protector $(LIB) -c -fno-builtin -W -Wstrict-prototypes -Wmissing-prototypes
LDFLAGS =  -m elf_i386 -Ttext $(ENTRY_POINT) -e main -Map $(BUILD_DIR)/kernel.map
OBJS = $(BUILD_DIR)/main.o $(BUILD_DIR)/init.o $(BUILD_DIR)/interrupt.o \
